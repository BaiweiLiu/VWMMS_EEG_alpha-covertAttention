function [data_output,velocity_output,time_output] = PBlab_gazepos2shift_1D(cfg, data_input, time_input)
...
% "Functional but not obligatory link between microsaccades and neural modulation by covert spatial attention" Baiwei Liu, Anna C. Norbe, Freek van Ede
...
velocity_output = data.absder(:,usabletimevec);
